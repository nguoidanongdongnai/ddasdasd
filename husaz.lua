...
function UILibrary.Main(PrjName,HideKey)
	...
	HideMain.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
	...
	List.ScrollBarImageColor3 = Color3.fromRGB(255, 102, 0)
	...
	function Tabs.Loader()
		...
		for i = 1,4 do
			...
			Circle.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
	...
	function Tabs.NewTab(TabName)
		...
		Elements.ScrollBarImageColor3 = Color3.fromRGB(255, 102, 0)
		...
		for index,page in next,Pages:GetChildren() do
			if page.Name ~= "UIPageLayout" and (page.Name == Frame.Name and index == 2) then
				...
				TweenService:Create(TabButton,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255, 102, 0)}):Play()	
		...
		function ElementsLib.NewSection(SectionName)
			...
			function InSection.NewToggle(ToggleText,UserFunc,defbool)
				...
				Checker.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
			...
			function InSection.NewSlider(SliderText,min,max,precise,UserFunc,defvalue)
				...
				Progress.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
			...
			function InSection.NewDropdown(placeholder,Selectables,func,IsMulti)
				...
				local function NewSelectable(Text,val)
					...
					ChoosedCircle.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
					...
					InnerCircle.BackgroundColor3 = Color3.fromRGB(255, 102, 0)
			...
			function InSection.NewButton(btnText,func)
				...
				Button.MouseButton1Down:Connect(function()
					TweenService:Create(Button,TweenInfo.new(0.25),{BackgroundTransparency = 0.3,BackgroundColor3 = Color3.fromRGB(255, 102, 0)}):Play()
				end)
